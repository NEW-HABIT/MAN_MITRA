    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[#f4f8fc] px-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900">Create your sanctuary</h2>
          <p className="text-xs text-slate-500 mt-1">Empathetic support is just a few steps away.</p>
        </div>
        ...
        {success ? (
          ...
          >
            ...
            <p className="text-xs text-slate-600 max-w-sm mx-auto leading-relaxed">
              We have sent a verification link to <strong className="text-slate-900">{formData.email}</strong>. 
